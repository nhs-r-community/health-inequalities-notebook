...
-   For further information or to discuss the results, please contact [Dr John Ford](j.a.ford@qmul.ac.uk) or [Mr Cameron Appel](c.appel@qmul.ac.uk).
...
Average life expectancy for men is **`r round(df_filter[df_filter$Indicator == "Life_Expectancy_Male", ]$quin_1, 1)`** in the least deprived 20% and **`r round(df_filter[df_filter$Indicator == "Life_Expectancy_Male", ]$quin_5, 1)`** in the most deprived 20%.

Average life expectancy for women is **`r round(df_filter[df_filter$Indicator == "Life_Expectancy_Female", ]$quin_1, 1)`** in the least deprived 20% and **`r round(df_filter[df_filter$Indicator == "Life_Expectancy_Female", ]$quin_5, 1)`** in the most deprived 20%.
