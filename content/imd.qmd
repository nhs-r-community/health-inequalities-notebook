...
# [TODO] find way to get IMD without downloading 32,844 obs
...
pc_imd <- NHSRpostcodetools::postcode_data_join(.data = postcodes$value) |> 
  ...
  left_join(imd |> 
              select(lsoa_code_2011,
                     score = index_of_multiple_deprivation_imd_score,
                     national_decile = index_of_multiple_deprivation_imd_decile_where_1_is_most_deprived_10_percent_of_lso_as), join_by(lsoa_code == lsoa_code_2011)) |> 
   mutate(imd_decile_local = ntile(-score, n = 10)) # creating new deciles from the data provided
